...
from mm_pipeline.tracking.select import WithinPairScorer, build_scorer

from .aggregation import build_per_pair_features
from .decisions import Action, DropReason, QADecision
from .detectors import NeverAnomalous, ModelViolationDetector, build_detector
...
def apply_qa_workflow(
    ...
    *,
    ...
    anomaly_detector: Optional[ModelViolationDetector] = None,
